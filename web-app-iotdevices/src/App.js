...
var author$project$Model$Index = {$: 'Index'};
var author$project$Model$Devices = {$: 'Devices'};
var author$project$Model$Error = {$: 'Error'};
var author$project$Model$MyPage = {$: 'MyPage'};
...
var author$project$Route$urlParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2(elm$url$Url$Parser$map, author$project$Model$Index, elm$url$Url$Parser$top),
			A2(
			elm$url$Url$Parser$map,
			author$project$Model$MyPage,
			elm$url$Url$Parser$s('mypage')),
			A2(
			elm$url$Url$Parser$map,
			author$project$Model$Devices,
...
var author$project$Route$urlToPage = function (url) {
	return A2(
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var page = author$project$Route$urlToPage(url);
		...
		if (msg.$ === 'LinkClicked') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						page: author$project$Route$urlToPage(url),
						url: url
					}),
				elm$core$Platform$Cmd$none);
		}
...
var author$project$Page$Devices$view = function (model) {
	return {
...
var author$project$Main$view = function (model) {
	...
	switch (_n0.$) {
		case 'Index':
			return author$project$Page$Index$view(model);
		case 'MyPage':
			return author$project$Page$MyPage$view(model);
		case 'Devices':
			return author$project$Page$Devices$view(model);
		default:
			return author$project$Page$Error$view(model);
	}
};
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: author$project$Model$UrlChanged,
		onUrlRequest: author$project$Model$LinkClicked,
